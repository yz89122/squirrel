...
```go
import "github.com/yz89122/squirrel"
```


[![GoDoc](https://godoc.org/github.com/yz89122/squirrel?status.png)](https://godoc.org/github.com/yz89122/squirrel)
...
```go
import sq "github.com/yz89122/squirrel"
...
* **How can I build an IN query on composite keys / tuples, e.g. `WHERE (col1, col2) IN ((1,2),(3,4))`? ([#104](https://github.com/yz89122/squirrel/issues/104))**
...
* **Why doesn't `Eq{"mynumber": []uint8{1,2,3}}` turn into an `IN` query? ([#114](https://github.com/yz89122/squirrel/issues/114))**
